...
def reset_button  (parent,**config):
    return Button(parent,command=model.reset,**config,fg="purple")
 
  
def start_button  (parent,**config):
    return Button(parent,command=model.start,**config,fg="purple")
 
  
def stop_button  (parent,**config):
    return Button(parent,command=model.stop,**config,fg="purple")
 
  
def step_button  (parent,**config):
    return Button(parent,command=model.step,**config,fg="purple")
 
  
def object_button  (parent,**config):
    def doit():
        model.select_object(config['text'])
    return Button(parent,command=doit,**config,fg="purple")
...
def progress  (parent,**config):
    global the_progress
    the_progress = Label(parent,**config,fg="purple")
    return the_progress
